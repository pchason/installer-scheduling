...
const schemaDescriptions = [
  ...
  'installers.installer_id (serial) - Unique identifier for the installer',
  ...
  'geographic_locations.location_id (serial) - Unique identifier for the location',
  ...
  'installer_locations.installer_id (integer) - Reference to installer',
  'installer_locations.location_id (integer) - Reference to location',

  'Table: jobs - Represents scheduled jobs that need to be completed by installers who will be or are already assigned',
  'jobs.job_id (serial) - Unique identifier for the job',
  ...
  'jobs.location_id (integer) - Reference to geographic location',
  ...
  'purchase_orders.po_id (serial) - Unique identifier for the purchase order',
  'purchase_orders.job_id (integer) - Reference to the job',
  ...
  'job_schedules.schedule_id (serial) - Unique identifier for the schedule',
  'job_schedules.job_id (integer) - Reference to the job',
  ...
  'installer_assignments.assignment_id (serial) - Unique identifier for the assignment',
  'installer_assignments.schedule_id (integer) - Reference to the job schedule',
  'installer_assignments.installer_id (integer) - Reference to the installer',
  'installer_assignments.po_id (integer) - Reference to the purchase order',
